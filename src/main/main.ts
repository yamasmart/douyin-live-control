...
function registerIpc(): void {
  ...
  ipcMain.handle(IPC.getAi, () => manager.getAi());
  ipcMain.handle(IPC.setAi, (_e, ai: AiConfig) => manager.setAi(ai));
  ipcMain.handle(IPC.aiExpand, (_e, input: ExpandInput) => manager.aiExpand(input));
